...
class SolubilityGN(nn.Module):
    def __init__(self, num_layers, hidden_bias, hidden_node, dropout, aggregation):
        ...
        self.encoder = nn.Sequential(OrderedDict({
            'edge': tg.EdgeLinear(hidden_edge, edge_features=8),
            'edge_relu': tg.EdgeReLU(),
            'node': tg.NodeLinear(hidden_node, node_features=167),
        ...
        self.readout_globals = tg.GlobalLinear(4, global_features=hidden_global, bias=True)
