...
def get_feature(mol_list,name_list,matrix_list,pu_index,pair_atom_dist,total_inner_dist,MACCS_dict):
    node_feature_dist={}
    total_edge_list=[]
    edge_num_list = []
    senders_list={}
    ...
    for i, mol in enumerate(mol_list):
        if not mol:
            print("Skipping invalid molecule while building graph features for:", name_list[i])
            continue
